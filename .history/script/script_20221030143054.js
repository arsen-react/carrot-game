...
const  incrementSchyot = () => {
  const pointsInnerHTML = document.getElementById('points').innerHTML
  let points = parseInt(pointsInnerHTML)
...
const checkBunnyStep = (line, step, edgeCoordinate, nextEdge) => {
  ...
  if (nextSlot === EMPTY_SLOT) {
    ...
    setImagePosition(CARROT_SLOT, "bunny-img", "bunnyID");
    incrementSchyot()
  } else {
